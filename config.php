...
<div class="row">
  <div class="col-lg-10 col-lg-offset-1 border-div">
    <h4 class="text-center"><strong>Configurações</strong></h4><hr>
    
    <a href="change_name.php" class="btn btn-primary btn-block">Alterar Nome</a>
    <a href="change_passwd.php" class="btn btn-primary btn-block">Alterar Senha</a>
