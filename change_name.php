...
if(isset($_POST["first_name"]) && isset($_POST["last_name"])){
    ...
    <strong>Sucesso!</strong> O nome foi alterado com êxito.
    </div>";
    }else{
        echo "<div class='alert alert-danger'>
    <strong>Falha!</strong> O nome não foi alterado.
    </div>";
    }
    mysqli_close($conn);
}
?>
    ...
    <form method="post">
      <div class="form-group">
        <label for="inputTitleCommunity">Primeiro Nome</label>
        <input type="text" class="form-control" value="<?php echo $first_name; ?>" name="first_name" id="inputTitleCommunity">
      </div>
      <div class="form-group">
        <label for="inputDescCommunity">Sobrenome</label>
        <input type="text" class="form-control" value="<?php echo $last_name ?>" name="last_name" id="inputDescCommunity">
      </div>
