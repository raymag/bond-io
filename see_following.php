...
<div class="row">
  <div class="col-lg-10 col-lg-offset-1 border-div">
    <h4 class="text-center"><strong>Pessoas que você segue</strong></h4><hr>
    <?php
      $conn = connect();
      $id_user = $_SESSION["id_user"];
      ...
      $sql = "SELECT * FROM follows
       ...
       WHERE follows.follower = '$id_user'
      ...
      if($query = mysqli_query($conn, $sql)){
                    ...
                    $sql = "SELECT * FROM follows WHERE follower = $id_user AND following = $id_user2";
                     if($query2 = mysqli_query($conn, $sql)){
                         ...
                         if(isset($dt["follower"])){
                           echo "<a title='Deixar de seguir' href='follow.php?u=".$id_user2."&m=unfollow&l=see_following.php' 
                           class='btn btn-warning'>
                             Deixar de Seguir</a>";
                         }else{
                          echo "<a title='Seguir' href='follow.php?u=".$id_user2."&m=follow&l=see_following.php' 
        ...
        if(count($followers)==0){
          echo "<h4 class='text-center'>Você não está seguindo nenhuma pessoa...</h4>";
        }
        else{
        }
      }
